...
def main():
    ...
    parser.add_argument("--quantize", action='store_true', help="Quantiza model with int8")
    parser.add_argument("--profile", action='store_true', help="Launch profiler")
    ...
    if args.profile:
        with torch.autograd.profiler.profile() as prof:
            for prompt_text in prompt_text_list:
                ...
                delta = end - start
                print("Processing Time: %.3f sec" % (delta.total_seconds()))
                total_delta += delta
    ...
    print("Total Processing Time: %.3f sec, Avg Processing Time: %.3f sec" % (total_delta.total_seconds(), total_delta.total_seconds()/len(prompt_text_list)))
